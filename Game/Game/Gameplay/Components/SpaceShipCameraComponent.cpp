...
//--------------------------------------------------------------------------------
CSpaceShipCameraComponent:: CSpaceShipCameraComponent()
    : m_parentToCameraDir           ( 0.f, 0.f, -1.f)
    , m_parentToCameraDistance      ( 8.f )
    , m_spaceShipUpdateComponent    ( NULL )
{
}
...
//--------------------------------------------------------------------------------
void CSpaceShipCameraComponent::OnUpdate( float deltaTime )
{
...
//--------------------------------------------------------------------------------
void CSpaceShipCameraComponent::PrivateUpdate(float deltaTime)
{
...
//--------------------------------------------------------------------------------
void CSpaceShipCameraComponent::Apply()
{
    ...
    pRenderCamera->SetFov( 52.f );
}

//--------------------------------------------------------------------------------
void CSpaceShipCameraComponent::GetCameraTM( m4x4& outTM)
{
    outTM = i4x4;
