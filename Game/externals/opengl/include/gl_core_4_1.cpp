...
namespace gl
{
	namespace exts
	{
		LoadTest var_ARB_texture_compression;
	...
	namespace _detail
	{
		typedef void (CODEGEN_FUNCPTR *PFNCOMPRESSEDTEXIMAGE1DARB)(GLenum, GLint, GLenum, GLsizei, GLint, GLsizei, const GLvoid *);
		PFNCOMPRESSEDTEXIMAGE1DARB CompressedTexImage1DARB = 0;
		typedef void (CODEGEN_FUNCPTR *PFNCOMPRESSEDTEXIMAGE2DARB)(GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, const GLvoid *);
		PFNCOMPRESSEDTEXIMAGE2DARB CompressedTexImage2DARB = 0;
		typedef void (CODEGEN_FUNCPTR *PFNCOMPRESSEDTEXIMAGE3DARB)(GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, const GLvoid *);
		PFNCOMPRESSEDTEXIMAGE3DARB CompressedTexImage3DARB = 0;
		typedef void (CODEGEN_FUNCPTR *PFNCOMPRESSEDTEXSUBIMAGE1DARB)(GLenum, GLint, GLint, GLsizei, GLenum, GLsizei, const GLvoid *);
		PFNCOMPRESSEDTEXSUBIMAGE1DARB CompressedTexSubImage1DARB = 0;
		typedef void (CODEGEN_FUNCPTR *PFNCOMPRESSEDTEXSUBIMAGE2DARB)(GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, const GLvoid *);
		PFNCOMPRESSEDTEXSUBIMAGE2DARB CompressedTexSubImage2DARB = 0;
		typedef void (CODEGEN_FUNCPTR *PFNCOMPRESSEDTEXSUBIMAGE3DARB)(GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, const GLvoid *);
		PFNCOMPRESSEDTEXSUBIMAGE3DARB CompressedTexSubImage3DARB = 0;
		typedef void (CODEGEN_FUNCPTR *PFNGETCOMPRESSEDTEXIMAGEARB)(GLenum, GLint, GLvoid *);
		PFNGETCOMPRESSEDTEXIMAGEARB GetCompressedTexImageARB = 0;
		
		static int Load_ARB_texture_compression()
		{
			int numFailed = 0;
			CompressedTexImage1DARB = reinterpret_cast<PFNCOMPRESSEDTEXIMAGE1DARB>(IntGetProcAddress("glCompressedTexImage1DARB"));
			if(!CompressedTexImage1DARB) ++numFailed;
			CompressedTexImage2DARB = reinterpret_cast<PFNCOMPRESSEDTEXIMAGE2DARB>(IntGetProcAddress("glCompressedTexImage2DARB"));
			if(!CompressedTexImage2DARB) ++numFailed;
			CompressedTexImage3DARB = reinterpret_cast<PFNCOMPRESSEDTEXIMAGE3DARB>(IntGetProcAddress("glCompressedTexImage3DARB"));
			if(!CompressedTexImage3DARB) ++numFailed;
			CompressedTexSubImage1DARB = reinterpret_cast<PFNCOMPRESSEDTEXSUBIMAGE1DARB>(IntGetProcAddress("glCompressedTexSubImage1DARB"));
			if(!CompressedTexSubImage1DARB) ++numFailed;
			CompressedTexSubImage2DARB = reinterpret_cast<PFNCOMPRESSEDTEXSUBIMAGE2DARB>(IntGetProcAddress("glCompressedTexSubImage2DARB"));
			if(!CompressedTexSubImage2DARB) ++numFailed;
			CompressedTexSubImage3DARB = reinterpret_cast<PFNCOMPRESSEDTEXSUBIMAGE3DARB>(IntGetProcAddress("glCompressedTexSubImage3DARB"));
			if(!CompressedTexSubImage3DARB) ++numFailed;
			GetCompressedTexImageARB = reinterpret_cast<PFNGETCOMPRESSEDTEXIMAGEARB>(IntGetProcAddress("glGetCompressedTexImageARB"));
			if(!GetCompressedTexImageARB) ++numFailed;
			return numFailed;
		}
	...
	namespace sys
	{
		namespace 
		{
			...
			{
				table.reserve(3);
				table.push_back(MapEntry("GL_ARB_texture_compression", &exts::var_ARB_texture_compression, _detail::Load_ARB_texture_compression));
			...
			{
				exts::var_ARB_texture_compression = exts::LoadTest();
		...
		namespace 
		{
			static void ProcExtsFromExtList(std::vector<MapEntry> &table)
			{
				...
				for(iLoop = 0; iLoop < iNumExtensions; iLoop++)
				{
                    ...
                    THOT_TRACE_LINE("LOADING EXTENSION[%s]", strExtensionName);
					LoadExtByName(table, strExtensionName);
				}
                
                const char *strExtensionName = "GL_ARB_program_interface_query";
                THOT_TRACE_LINE("LOADING EXTENSION[%s]", strExtensionName);
				LoadExtByName(table, strExtensionName);
			}
