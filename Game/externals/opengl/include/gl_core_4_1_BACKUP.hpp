...
#if defined(NO_ERROR)
#   error NO_ERROR is still defined. Wtf is this mother fucker?
#endif
...
namespace gl
{
	...
	enum
	{
		...
		//COMPATIBLE_SUBROUTINES taken from ext: ARB_program_interface_query
		DOUBLE_MAT2                      = 0x8F46,
		...
		//NUM_COMPATIBLE_SUBROUTINES taken from ext: ARB_program_interface_query
		PATCHES                          = 0x000E,
